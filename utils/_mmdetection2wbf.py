...
class mmdetection2wbf:
    def __init__(self, gt_path="/content/drive/MyDrive/Makale_2/ground_truth/ground_truth.json", json_path=None,
                 csv_path=None, init=True):
    ...
    def main(self):
        ...
        for file in glob.glob(self.json_path + "/*.json"):
            ...
            self._json_2_Csv(file_name + ".csv", data)
